...
Shader "PicoTanks/SquashAndStretch"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = tex2D(_MainTex, (((mul(UNITY_MATRIX_MV, fixed4(ase_vertexNormal, 0.0)).xyz).xy * 0.5) + 0.5)).rgb;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.SamplerNode;173;-916.077,1398.61;Float;True;Property;_MainTex;Texture;0;0;Create;True;0;0;False;0;cadb484151570cc409c732981288cd10;aaf14129c2597e54eae53c3a52bab495;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
